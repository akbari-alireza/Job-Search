...
function Search() {
  return (
    <div className='searchDiv grid gap-10 bg-greyIsh rounded-[10px] p-[3rem]'>
      <form action="">
        <div className=' fistDiv flex justify-between items-center rounded-[8px] gap-[10px] bg-white p-5 shadow-lg shadow-greyIsh-700'>
          <div className='flex gap-2 items-center'>
           <AiOutlineSearch className=' text-[25px] icon'/> 
           <input type="text" className='bg-transparent text-blue-500 focus:outline-none w-[100%] ' placeholder='Search Here Job...'  />
      ...
      <div className="secDiv flex items-center gap-10 justify-center">
        ...
        <div className="singleSearch flex items-center gap-2">
          ...
          <select name="" id="type" className=' bg-white rounded-[3px] px-4 py-1 '>
            ...
            <option value="">Prart-time</option>
          </select>
        </div>
